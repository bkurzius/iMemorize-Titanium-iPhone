...
// in simulator we redefine to format for iMemorizeMobile Developer console
...
{\
	NSString * exceptionName = [@"org.imemorizemobile." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.imemorizemobile";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIiMemorizeMobileNativeItemNone = -1, 
	UIiMemorizeMobileNativeItemSpinner = -2,
	UIiMemorizeMobileNativeItemProgressBar = -3,
	
	UIiMemorizeMobileNativeItemSlider = -4,
	UIiMemorizeMobileNativeItemSwitch = -5,
	UIiMemorizeMobileNativeItemMultiButton = -6,
	UIiMemorizeMobileNativeItemSegmented = -7,
	
	UIiMemorizeMobileNativeItemTextView = -8,
	UIiMemorizeMobileNativeItemTextField = -9,
	UIiMemorizeMobileNativeItemSearchBar = -10,
	
	UIiMemorizeMobileNativeItemPicker = -11,
	UIiMemorizeMobileNativeItemDatePicker = -12,
	
	UIiMemorizeMobileNativeItemInfoLight = -13,
	UIiMemorizeMobileNativeItemInfoDark = -14,
	
	UIiMemorizeMobileNativeItemDisclosure = -15,
	
	UIiMemorizeMobileNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all iMemorizeMobile instances of
