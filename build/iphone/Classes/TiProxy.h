...
//Rare exceptions to indicate a bug in the _imemorizemobile code (Eg, function that a subclass should have implemented)
...
/**
 The base class for iMemorizeMobile proxies.
 */
