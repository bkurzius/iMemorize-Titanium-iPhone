...
@interface iMemorizeMobileObject : KrollCoverageObject {
#else
@interface iMemorizeMobileObject : KrollObject {
#endif
@private
...
extern NSString * iMemorizeMobile$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	iMemorizeMobileObject *_imemorizemobile;
    KrollObject* console;
	BOOL shutdown;
