...
/**
 Base class for all iMemorizeMobile views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the iMemorizeMobile view hierarchy (such as wrapped iOS UIViews) was touched.
