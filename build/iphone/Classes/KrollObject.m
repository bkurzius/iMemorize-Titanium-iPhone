...
//@interface iMemorizeMobileObject : NSObject
//@end

@interface iMemorizeMobileObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[iMemorizeMobileObject class]])
		{
			for (NSString *key in [[(iMemorizeMobileObject*)o modules] allKeys])
			{
